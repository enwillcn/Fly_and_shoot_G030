...
static QState Tunnel_show_logo(Tunnel * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        case Q_ENTRY_SIG: {
            ...
            me->blink_ctr = 0U;
            BSP_paintString(24U, (GAME_TUNNEL_HEIGHT / 2U) - 12U, "Quantum LeAps");
            BSP_paintString(16U, (GAME_TUNNEL_HEIGHT / 2U) -2U, "enwillcn@163.com");

            BSP_paintString(1U, GAME_TUNNEL_HEIGHT - 18U, "Fire missile: BTN1");
            BSP_paintString(1U, GAME_TUNNEL_HEIGHT - 10U, "Fly ship up:  BTN2");
        ...
        case BLINK_TIMEOUT_SIG: {
            ...
            if (me->blink_ctr == 0U) {
                BSP_paintString(24U + 8U*6U, (GAME_TUNNEL_HEIGHT / 2U) - 12U, "LeAps");
                BSP_updateScreen();
                status_ = Q_HANDLED();
            }
